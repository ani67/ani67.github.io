...
### A 2025 PMC study tracked seven hundred image-generation trajectories across major foundation models and found them converging on just twelve visual attractors. Model collapse loses the tails first, and subcultural aesthetics are the tails.
 The same compression appears in cultural formats: a global short-form vertical template has collapsed the long tail of distinct registers, a dynamic I traced through the taste-cycle in an earlier piece, [*The Politics of Taste*](https://anidalal.com/posts/the-politics-of-taste/) .
...
## Further Reading
 - Ani Dalal, [*The Politics of Taste*](https://anidalal.com/posts/the-politics-of-taste/). Companion piece on the taste-cycle dynamics behind cultural format convergence.
