---
title: "Feeling Nothing and Everything All at Once"
date: "2026-03-03"
description: "Your soul was manufactured. Reckoning with that is probably the most honest thing you've got
"
tags: ["vibes"]
image: null
published: true
...
This is what makes the current condition different from every previous account of media and manipulation. Thinkers like [Debord and Baudrillard](https://www.marxists.org/reference/archive/debord/society.htm) worried about reality being replaced by representation — but they still assumed there was a self underneath that could, in theory, see through it. A real you that the spectacle was obscuring.
...
[McLuhan's insight](https://web.mit.edu/allanmc/www/mcluhan.mediummessage.pdf) was that the medium shapes the message — that the form of communication restructures cognition regardless of its content. The printing press produced the conditions for linear argument, private reading, the individual interpreting alone. Television restructured time, dissolved the boundary between public and private. Each medium produced a different kind of human. But each was still, in some meaningful sense, a channel. Something passed through it.
...
It does not liberate. It does not restore the prior self. [Žižek's warning](https://www.youtube.com/watch?v=hpAMbpQ8J7g) is real: the noticing gets recuperated, turned into content, sold back as authentic alienation, enrolled in the attention economy it was supposed to escape. The critique becomes a podcast. The resistance becomes a brand.
...
### Further Reading
Debord, *Society of the Spectacle* — [full text](https://www.marxists.org/reference/archive/debord/society.htm).

McLuhan, *Understanding Media* — [The Medium is the Message](https://web.mit.edu/allanmc/www/mcluhan.mediummessage.pdf). 

Stiegler on pharmacology — [Elements of Pharmacology](https://www.themontrealreview.com/Articles/Bernard_Stiegler_Elements_of_Pharmacology.php). 

Virilio, *Speed and Politics* — [publisher page](https://mitpress.mit.edu/9780936756332/speed-and-politics/). 

Bifo Berardi & Fisher in conversation — [Give Me Shelter](https://www.frieze.com/article/give-me-shelter-mark-fisher).